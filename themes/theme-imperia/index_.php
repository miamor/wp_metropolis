...
<div id="virtual-360" class="section section-virtual">
<div class="posa">
	<div class="container clearfix">
		<div class="dtb">
			<div class="dtbc">
				<p>
					<a href="#360-virtual-tour" id="virtual-tour" data-src="http://metropolis.vinhomes.vn/wp-content/themes/metropolis/assets/360/index.html">
						<img src="http://metropolis.vinhomes.vn/wp-content/themes/metropolis/assets/images/360-circle.png" alt="">
					</a>
				</p>
			</div>
		</div>
...
<div id="360-popup" class="popup close-wrap">
...
$('#virtual-tour').click(function(event){
	...
	$('#360-popup .popup-inner').css('margin-top', top).prepend( '<iframe src="'+ link + '" style="width: 100%; height: '+ height +'px;" />' );
	$('#360-popup').fadeIn().addClass('opened');
	$('#360-popup').css('width', '100%');
});

$('#360-popup .close, #360-popup .close-bg').click(function(){
	$(this).parents('.close-wrap').fadeOut().removeClass('opened');
	$('#360-popup .popup-inner iframe').remove();
	return false;
});
});
</script>
...
<div class="container clearfix">
	<div class="section-content the-content a-btn scroll-normal list-triangle">
		<p>Tất cả các căn hộ tại Vinhomes Metropolis được thiết kế với phong cách hiện đại, mang lại không gian sống đẳng cấp bậc nhất cho các chủ nhân tương lai:</p>
...
<div class="posr clearfix">
	...
	<div class="tabbed">
			...
			<div class="block clearfix odd">
				<div class="grid9">
					<div class="description">
						<p><strong>TOÀ M1 - TRÁI TIM CỦA VINHOMES METROPOLIS</strong></p><p>Với chiều cao 41 tầng, tòa M1 nằm cận kề với khối tháp văn phòng, trường Tiểu học và THCS Vinschool và tiếp giáp gần nhất với mặt đường Liễu Giai và Kim Mã. Đặt trên khối đế là trung tâm thương mại hiện đại, M1 kết nối với hai tòa tháp còn lại bằng khu cảnh quan và tiện ích trên tầng 4. Từ đây, tất cả các cư dân được thỏa sức tận hưởng tầm nhìn vào thành phố sôi động và thư giãn với những không gian xanh và tiện ích đẳng cấp.</p><br/>Thông tin về từng loại mục đích sử dụng và phần diện tích sử dụng chung đối và tòa cao tầng được thể hiện chi tiết tại Hợp đồng mua bán.							</div>
				</div>
				<div id="swiper-slide-m1" class="grid10 fl swiper-container"
					data-options='{
						"speed": 1000,
			...
			<div class="block clearfix odd">
				<div class="grid9">
					<div class="description">
						<p><strong>TOÀ M2 - SỰ LỰA CHỌN HOÀN HẢO</strong></p><p>Tòa M2 sở hữu tọa độ vàng trong lòng dự án, là tòa căn hộ kết nối 2 tòa M1 và tòa M3, M2 nằm đối diện vườn nổi tiểu cảnh độc đáo, hai bên là hai khu tiện ích trung tâm bao gồm khu bể bơi rộng rãi và khu vui chơi trẻ em hấp dẫn. <br><br>Tòa M2 nằm song song, tiếp giáp với mặt đường Kim Mã nhiều nhất, và có tầm nhìn khoáng đạt, rộng mở ra cả 4 hồ.</p><br/>Thông tin về từng loại mục đích sử dụng và phần diện tích sử dụng chung đối và tòa cao tầng được thể hiện chi tiết tại Hợp đồng mua bán.</p>							</div>
				</div>
				<div id="swiper-slide-m2" class="grid10 fl swiper-container"
					data-options='{
						"speed": 1000,
									...
									<polygon class="st0" data-src="http://metropolis.vinhomes.vn/wp-content/themes/metropolis/assets/images/surfaces/m2/large/M2_02.jpg" fill="#FFFFFF" points="191.268,222.661 191.298,334.859 290.928,334.859 290.928,304.62 306.558,304.62 306.558,222.661
										"/>
															...
															<div class="block clearfix odd">
																<div class="grid9">
																	<div class="description">
																		<p><strong>TOÀ M3 - SỰ LỰA CHỌN HOÀN HẢO</strong></p><p>Vị trí kế cận trường học Vinschool và tiếp giáp với Đại sứ quán Nhật Bản, tòa M3 là lựa chọn hoàn hảo dành cho những cư dân văn minh, hiện đại. M3 sở hữu vị trí đặc biệt, nằm gọn trong lòng dự án, vì thế lựa chọn căn hộ tại đây, chủ nhân tương lai sẽ được tận hưởng không gian yên tĩnh, cách xa mặt đường đủ để không bị làm phiền bởi âm thanh thành phố.</p><br/>Thông tin về từng loại mục đích sử dụng và phần diện tích sử dụng chung đối và tòa cao tầng được thể hiện chi tiết tại Hợp đồng mua bán.							</div>
																</div>
																<div id="swiper-slide-m3" class="grid10 fl swiper-container"
																	data-options='{
																		"speed": 1000,
